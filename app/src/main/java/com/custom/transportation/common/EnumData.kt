...
enum class RouteType(@ColorRes val colorId: Int, @StringRes val nameId: Int) {
    AIRPORT(R.color.bus_airport, R.string.route_air), TOWN(R.color.bus_town, R.string.route_town),
    ...
    INCHEON(R.color.bus_incheon, R.string.route_incheon), GYUNGGI(R.color.bus_gyunggi, R.string.route_gyunggi),
